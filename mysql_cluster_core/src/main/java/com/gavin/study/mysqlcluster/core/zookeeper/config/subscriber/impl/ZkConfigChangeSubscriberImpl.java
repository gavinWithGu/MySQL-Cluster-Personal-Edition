package com.gavin.study.mysqlcluster.core.zookeeper.config.subscriber.impl;
...
import com.gavin.study.mysqlcluster.core.zookeeper.config.listerner.impl.ConfigChangeListener;
...
import com.gavin.study.mysqlcluster.utils.ZkUtils;
...
public class ZkConfigChangeSubscriberImpl implements ConfigChangeSubscriber {
	...
	static{
		rootNode = ConfigFileUtil.ZK_CONFIGS_ROOTNODE;
